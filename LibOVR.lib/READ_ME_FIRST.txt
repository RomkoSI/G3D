...
the 0.6 dropdown at https://developer.oculusvr.com/downloads.

The Runtime must be installed before running any apps built using Oculus Rift SDK 0.6 (DK1 or DK2).
It should be installed to improve the DK1 experience when running apps older than SDK version 0.3.

If you have any questions or comments, please visit https://forums.oculus.com/.
